...
def cmd_generate(args: argparse.Namespace) -> int:
    ...
    written = write_images(extract_image_payloads(response), args.out, output_format, args.size)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    gen.add_argument("--image-role", action="append", help="Semantic role for each --image, in the same order. Repeatable.")
    ...
    gen.add_argument("--trace-out", help="Write a JSON generation trace with endpoint, model, input hashes, and output hashes.")
