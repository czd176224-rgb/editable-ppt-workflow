...
ENV_FIELDS = ("IMAGE_TO_EDITABLE_PPT_IMAGE_MODEL",)
...
Backend selection:
  ...
  OPENAI_API_KEY fallback is disabled; image work uses the ChatGPT subscription.
...
def _ensure_codex_oauth(dry_run: bool) -> None:
    ...
    _die(
        ...
        "Open Codex and sign in with ChatGPT, then retry. OPENAI_API_KEY is not used."
    )
...
def _generate(args: argparse.Namespace) -> None:
    ...
    _die("Codex-managed image generation is unavailable; OPENAI_API_KEY fallback is disabled.")
...
def _edit(args: argparse.Namespace) -> None:
    ...
    _die("Codex-managed image editing is unavailable; OPENAI_API_KEY fallback is disabled.")
