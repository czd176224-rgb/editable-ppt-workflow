...
try:
    from .fixed_region_runtime import CONTENT_BOX, SLIDE, require_source_size
...
def deck_slide_layout(run_dir, deck):
    ...
    require_source_size(width_px, height_px)
    return dict(SLIDE)
...
def main():
    parser = argparse.ArgumentParser(description="Create a stable reconstruct-editable-slide run directory.")
