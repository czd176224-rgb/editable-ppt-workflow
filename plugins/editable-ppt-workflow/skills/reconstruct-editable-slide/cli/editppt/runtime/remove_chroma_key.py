#!/usr/bin/env python3
"""Remove a solid chroma-key background from a reconstruct-editable-slide image.
...
def _dependency_hint(package: str) -> str:
    ...
    install_hint = "`pipx install --force --editable <path-to-reconstruct-editable-slide>/cli`"
    return (
