...
0. source.png is the accepted Image2 visual design authority. Reconstruct its composition, geometry, hierarchy, palette, spacing, visual rhythm, and major decorative elements as closely as editable PowerPoint allows. Word/page_request remains the content authority. A material visual departure from source.png is a page failure, not creative freedom. The only permitted visual substitution is an explicit required authentic source image replacing the Image2-imagined lookalike in the same intended role.
