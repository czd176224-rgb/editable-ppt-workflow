...
The source is the accepted Image2 body design authority. Object-source decisions exist to reproduce that design editably, not to redesign it. Preserve composition, object geometry, hierarchy, palette, spacing, visual rhythm, and major decorative elements. Word and page-local comments remain the content authority. Only an explicit required authentic source image may replace an Image2-imagined lookalike, while preserving the intended visual role and layout.
