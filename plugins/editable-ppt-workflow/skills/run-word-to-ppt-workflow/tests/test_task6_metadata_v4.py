...
def test_release_metadata_is_consistently_v6_version() -> None:
    ...
    assert package["pluginVersion"] == manifest["version"] == "2.1.0"
    ...
    assert marketplace["interface"]["displayName"].endswith("2.1.0")
    ...
    assert package["localRepairEndpoint"] == "same-as-initial-operation"
