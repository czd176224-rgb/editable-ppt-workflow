...
description: Perform optional final inspection, validation, preview, and narrowly scoped repair of PPTX output with a preinstalled officecli command. Use only after the core editable PPT workflow has produced a deck; absence or failure of officecli must not block the core workflow.
---
